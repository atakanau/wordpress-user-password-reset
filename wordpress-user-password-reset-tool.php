...
<!DOCTYPE html>
	...
	<body class="wp-core-ui">
		...
		<div class="update-message notice inline notice-alt notice-error"><p>Delete this php file named "<?php echo $my_filename;?>" after using it. <a href="https://atakanau.blogspot.com/2021/06/wordpress-user-password-reset.html" >atakanau.blogspot.com</a></p></div>
	...
	<?php }elseif($show_page == "new"){ ?>
		<div id="login">
			<div class="updated-message updated"><p><i class="dashicons dashicons-wordpress"></i> <?php echo $message?></p></div>
